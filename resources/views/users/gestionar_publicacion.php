            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-file-text-o"></i>  Gestionar Publicacion
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <h3>Buscar estudiante:</h3>  
                       <form method="POST" action="gestionar_publicacion.php">
...
<?php
    ...
    if ((isset($_POST["buscar"])) && ($_POST["buscar"] == 'true')) {
        ...
        if ((isset($_POST["opcion"]) && ( $_POST["opcion"] == 'eliminar'))) {
            ...
            $con->eliminar('publicacion', "id_publicacion=" . $_POST["id_publicacion"]);
        ...
        $sql = "SELECT * FROM usuario AS u INNER JOIN publicacion AS p ON u.id_usuario=p.id_usuario AND u.cedula = " . $cedula . ";";

        $resultado = $con->query($sql);

        if ($con->n_filas($resultado) > 0) {
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="gestionar_publicacion.php">
                            ...
                            <input type="hidden" name="id_publicacion" id="id_publicacion" value="<?php  echo $datos["id_publicacion"];?>">
            ...
            echo '<div class=" col-lg-6 alert alert-danger"> Este usuario no posee publicaciones</div>';
        }
