        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
               ...
               <?php 
                    ...
                    $resultado = $con->get_fila($con->query($sql));
                ...
                <div class="row">
                    ...
                    <form method="POST" action="gestionar_materia.php">
                        ...
                        <input type="hidden" name="id_materia" id="id_materia" value="<?php echo $resultado["id_materia"]; ?>" />
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="codigo" id="codigo" required value="<?php echo $resultado["codigo"]; ?>"/>
                       ...
                       <div class="form-group "> 
                          ...
                          <select class="form-control" id="departamento" name="departamento" required>
                            <option value="Todos" <?php if($resultado["departamento"]== 'Todos') echo "selected" ?>>Todos</option>
                            <option value="Computacion" <?php if($resultado["departamento"]== 'Computacion') echo "selected" ?>>Computacion</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12 text-right">
                                ...
                                <button type="submit" class="btn btn-success preview-edit-button">
                                    <span class="fa fa-fw fa-check"></span> Modificar
                                </button>
                            </div>
